...
export default defineComponent({
  ...
  methods: {
    ...
    getDaultFeatures(){
      return [
        {'id': 'feature1', 'label': 'Low pitched tinnitus occurred within one month', 'value': '0'},
        {'id': 'feature2', 'label': 'History of cold or chronic rhinitis', 'value': '0'},
        {'id': 'feature3', 'label': 'Tinnitus sounds like roaring wind or tide', 'value': '0'},
        {'id': 'feature4', 'label': 'Restless insomnia with early morning awakening', 'value': '0'},
        {'id': 'feature5', 'label': 'Irritability insomnia and vivid dreams', 'value': '0'},
        {'id': 'feature6', 'label': 'Lower back pain and nocturnal emission', 'value': '0'},
        {'id': 'feature7', 'label': 'Impulsive and irritable personality', 'value': '0'},
        {'id': 'feature8', 'label': 'Heaviness in the head bitter or bland taste in the mouth', 'value': '0'},
        {'id': 'feature9', 'label': 'Sensation of emptiness in the ear', 'value': '0'},
        {'id': 'feature10', 'label': 'Ear fullness and blockage causing breathlessness', 'value': '0'},
        {'id': 'feature11', 'label': 'Worsens when standing up', 'value': '0'},
        {'id': 'feature12', 'label': 'Worsens after exertion', 'value': '0'},
        {'id': 'feature13', 'label': 'Greasy tongue coating', 'value': '0'},
        {'id': 'feature14', 'label': 'Yellow tongue coating', 'value': '0'},
        {'id': 'feature15', 'label': 'Floating pulse', 'value': '0'},
        {'id': 'feature16', 'label': 'Wiry pulse', 'value': '0'},
        {'id': 'feature17', 'label': 'Slippery pulse', 'value': '0'},
        {'id': 'feature18', 'label': 'Thin pulse', 'value': '0'}
        ]
    },
    getFeaturesZh(){
      return [
        {'id': 'feature1', 'label': '耳鸣声低沉，耳鸣发作一月内', 'value': '0'},
        {'id': 'feature2', 'label': '有感冒史，或素有鼻炎', 'value': '0'},
        {'id': 'feature3', 'label': '耳鸣轰轰如风声、潮声', 'value': '0'},
        {'id': 'feature4', 'label': '虚烦失眠，晨起早醒', 'value': '0'},
        {'id': 'feature5', 'label': '烦躁失眠，多梦', 'value': '0'},
        {'id': 'feature6', 'label': '腰酸，遗精', 'value': '0'},
        {'id': 'feature7', 'label': '性格急躁、易怒', 'value': '0'},
        {'id': 'feature8', 'label': '头昏沉重，口苦或口淡', 'value': '0'},
        {'id': 'feature9', 'label': '耳内空虚感', 'value': '0'},
        {'id': 'feature10', 'label': '耳胀，耳闭塞憋气', 'value': '0'},
        {'id': 'feature11', 'label': '站起时加重', 'value': '0'},
        {'id': 'feature12', 'label': '劳作后加重', 'value': '0'},
        {'id': 'feature13', 'label': '腻（苔）', 'value': '0'},
        {'id': 'feature14', 'label': '黄（苔）', 'value': '0'},
        {'id': 'feature15', 'label': '浮（脉）', 'value': '0'},
        {'id': 'feature16', 'label': '弦（脉）', 'value': '0'},
        {'id': 'feature17', 'label': '滑（脉）', 'value': '0'},
        {'id': 'feature18', 'label': '细（脉）', 'value': '0'}
        ]
    },
    changeLanguage(){
    ...
    submitForm() {
      ...
      axios
        ...
        // .get("http://121.4.79.250/api/predict", { 
